...
static const char *strMainNetDNSSeed[][2] = {
    {"chavezcointools.com", "162.213.215.55"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"chavezcointools.com", "testnet-seed.chavezcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Chavezcoin is probably already running."), addrBind.ToString().c_str());
        else
